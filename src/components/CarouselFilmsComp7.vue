...
export default {
  ...
  computed: {
    ...
    filmSelected2() {
      return this.$store.state.filmSelected2
    }
  },

  methods: {
    ...mapMutations(['setFilmSelected']),
    ...mapActions(['getFilmSelecteds']),
...
.click-info {
  ...
  width: 600px;
  height: auto;
  background-color: rgba(80, 80, 80, 0.486);
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
  box-shadow: 1px 3px 10px 5px rgba(214, 214, 214, 0.781);
