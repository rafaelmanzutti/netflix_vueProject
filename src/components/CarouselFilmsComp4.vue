      ...
      <div class="slider">
        <div class="sli">
          <div  v-for="(film, id) in films" :key="id" class="sli2">
            <div v-if="film.backdrop_path && film.poster_path" class="sli3" @mouseover="aplicarDisplay(id)" @mouseleave="!aplicarDisplay(id)">
              <div :class="{'invisible': aplicarDisplay}">
                <img :src="'https://image.tmdb.org/t/p/w500' + film.backdrop_path" alt="filmImage300px" >
                <h6>{{ film.release_date }}</h6>
              </div>
              <div :class="{'invisible': !aplicarDisplay}">
                <img :src="'https://image.tmdb.org/t/p/w300' + film.backdrop_path" alt="filmImage300px" >
